Vue.component('parallel', {
    template: `<div>
                    ...
                    <div style="display:flex; margin:0 auto;margin-top:-15px" :style="{'width' : (activities.length * 420) + 'px' }">
                            <div style="width:420px;" v-for="(element,index) in activities" :key="element.id">
                                <div style="height:35px;  opacity:0.8; width:100%; bottom:0px">
                                    <svg version="1.1" id="Layer_1" height="35px" width="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        ...
                                        <line id="svg_1" y2="10" x2="100%" y1="10" x1="0%" stroke-linecap="null" stroke-linejoin="null" stroke-dasharray="null" stroke-width="2" stroke="#000000" fill="none"/>
                                        <!-- Right -->
                                        <line id="svg_1" y2="10" x2="100%" y1="10" x1="0%" stroke-linecap="null" stroke-linejoin="null" stroke-dasharray="null" stroke-width="2" stroke="#000000" fill="none"/>

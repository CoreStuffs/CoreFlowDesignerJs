var coreflow = {
    designSurface : function (elementPath, opts, definitionObj) {
        var app = new Vue({
            el: elementPath,
            template: `<div v-cloak style="background-color:#EAEAEA;position:absolute; width:100%; height:100%; overflow:auto">
                           
                                <activitySequence :activities="definition.activities"/>
                    </div>`,
                data: function () {
                    return {
